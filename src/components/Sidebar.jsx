...
const Sidebar = () => {
  return (
    <div className=' h-auto px-2 py-5 bg-black mx-1 z-10 absolute top-56 left-0 border border-gray-800 
      ...
      <IoAdd className='text-gray-600 text-3xl cursor-pointer hover:text-[#2dc90a] hover:scale-110 transition-all duration-300 ease-in-out'/>

      <a href="https://github.com/heyits-deepak" target='_blank'>
      ...
      <a href="https://www.instagram.com/sharma_thepak?igsh=MWhzbXB6d3pvNnI0dg==" target='_blank'>
